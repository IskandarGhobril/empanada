...
- **NASDAQ stock and ETF data** (24.2M data points): Objective price movements and returns across 5,884 tickers
- **AAII Investor Sentiment Survey**: Weekly six-month forecasts from thousands of retail investors
- **Google Trends search data**: Revealed attention patterns for economic terms (e.g., "recession", "unemployment", "stock market")
